...
| 11   | Baixa      |✅️ Como tomador de decisão em políticas públicas, quero visualizar a integração da base de dados do IBAMA com base do RENAEST, para um maioor entendimento do projeto  | 7 horas          | 3      |
